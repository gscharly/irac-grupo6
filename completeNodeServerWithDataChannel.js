...
// Chane directory too path of current JavaScript program
var process = require('process');
//process.chdir(__dirname);
//quitar el comentario anterior si no se quiere poner el subdirectorio al final, por ej. https://...:8080/cap5/
